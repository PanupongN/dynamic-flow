// Simplified theme system for preview app
...
// Additional themes
const goldenBrownTheme: CompanyTheme = {
  id: 'goldenBrown',
  name: 'Golden Brown',
...
const mustardYellowTheme: CompanyTheme = {
  id: 'mustardYellow',
  name: 'Mustard Yellow',
...
// Nature Green Theme
const natureGreenTheme: CompanyTheme = {
  id: 'natureGreen',
  name: 'Nature Green',
...
export const companyThemes: Record<string, CompanyTheme> = {
  ...
  goldenBrown: goldenBrownTheme,
  mustardYellow: mustardYellowTheme,
...
// CSS Variable generator with enhanced semantic colors
export function generateCSSVariables(theme: CompanyTheme): string {
  return `
    :root {
      ...
      /* Semantic Colors - Enhanced with proper variations */
      ...
      /* Phone Input Theming */
      --phone-input-border: var(--color-border-main);
      --phone-input-border-focus: var(--color-primary);
      --phone-input-border-error: var(--color-negative-100);
      --phone-input-background: var(--color-background-paper);
      --phone-input-text: var(--color-text-primary);
    }
  `;
}
